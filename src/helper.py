...
if __name__ == '__main__':
    ...
    train_x_seg_path = '../resource/gen/train_x_cut_segment.txt'
    train_y_seg_path = '../resource/gen/train_y_cut_segment.txt'
    test_x_seg_path = '../resource/gen/test_x_cut_segment.txt'
